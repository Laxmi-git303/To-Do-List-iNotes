<?php 
  ...
  //INSERT INTO `notes` (`sno`, `title`, `description`, `tstamp`) VALUES (NULL, 'Buy Books', 'Buy BOOkS', current_timestamp());
  $insert=false;
  $update=false;
  $delete=false;
  ...
  if($_SERVER['REQUEST_METHOD']=='POST'){
    if(isset($_POST['snoedit'])){
      //update the record(form in modal contents are used)
     $sno=$_POST["snoedit"];
...
<head>
  ...
  <title>iNotes-Notes Making Easily</title>
    ...
    <script>
      ...
      Array.from(edits).forEach((element)=>{
        element.addEventListener("click",(e)=>{
            ...
            //modal activation using javascript
